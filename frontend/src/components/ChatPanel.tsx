  ...
  return (
    <>
      ...
      {!isOpen && (
        <button
          onClick={onToggle}
          className="fixed right-4 bottom-4 z-40 p-4 rounded-full shadow-2xl transition-all duration-300 bg-white/10 backdrop-blur-sm border border-white/10 text-white/80 hover:bg-white/20"
        >
          {/* Chat icon */}
